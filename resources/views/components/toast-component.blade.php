<div id="toastSuccess"
    class="absolute translate-x-full right-0 z-50 top-16  overflow-hidden gap-4 trans flex items-center transition-all shadow justify-start w-fit bg-white border-solid rounded-md border-l-2 border-t-1 border-green-500 px-5 py-4 pe-10">
