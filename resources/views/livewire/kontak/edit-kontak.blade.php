<div class="w-full h-full absolute z-50 top-0 left-0 flex items-center justify-center px-40 py-20 ">
    ...
    <div class="bg-white w-full h-full rounded-xl z-20 relative overflow-hidden pt-8">
        <div class="flex justify-between items-center absolute top-0 right-0 left-0 p-4 z-20 bg-orange-100">
            <h1 class="font-semibold text-gray-700 uppercase text-lg">Edit Kontak</h1>
            <i class="text-lg  ph-bold cursor-pointer transition-all ph-x text-gray-700 active:scale-90"
                wire:click='close'></i>
        </div>
        <div class=" h-full p-6 pt-10 overflow-y-scroll">
                    ...
                    <form action="/edit-kontak/{{ $idKontak }}" method="POST">
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" pattern="\d*" maxlength="16" minlength="16"  id="nikKontak" name="nikKontak" maxlength="16" 
                                    value="{{ $kontak->nik_kontak }}"
                                    class="bg-white border !border-orange-200 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5 dark:bg-gray-700 dark:border-orange-300 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500"
                            ...
                            <div>
                                ...
                                <select id="jenisKelamin" name="jenisKelamin" required
                                    ...
                                    <option value="laki-laki"
                                        {{ $kontak->jenis_kelamin == 'laki-laki' ? 'selected' : '' }}>
                                        Laki-laki</option>
                                    <option value="perempuan"
                                        {{ $kontak->jenis_kelamin == 'perempuan' ? 'selected' : '' }}>
                                        Perempuan</option>
                                </select>
                            </div>
                            <div>
                            ...
                            <div class="col-span-2">
                                ...
                                <div class="w-full h-fit flex justify-center ">
                                    <div id="mapEdit" wire:ignore
                                        class="w-1/2 h-80 rounded-lg z-10 shadow border-2 border-orange-500">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <li
                                        ...
                                        <div class="flex items-center ps-3">
                                            <input id="kontakSerumah1" type="radio" value="1"
                                                {{ $kontak->kontak_serumah == '1' ? 'checked' : '' }}
                                                name="kontakSerumah"
                                                class="w-4 h-4 text-orange-500 bg-gray-100 border-orange-300 focus:ring-orange-500   ">
                                    ...
                                    <li class="w-full border-b border-gray-200 sm:border-b-0 ">
                                        <div class="flex items-center ps-3">
                                            <input id="kontakSerumah2" type="radio" value="0"
                                                {{ $kontak->kontak_serumah == '0' ? 'checked' : '' }}
                                                name="kontakSerumah"
                                                class="w-4 h-4 text-orange-500 bg-gray-100 border-orange-300 focus:ring-orange-500   ">
