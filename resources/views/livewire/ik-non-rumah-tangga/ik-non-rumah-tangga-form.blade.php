<div class="h-fit w-full  pb-20">
    ...
    <div class="bg-white rounded-lg w-full overflow-hidden">
        ...
        <form action="/tambah-iknrt/{{ $index ? $index->id : '' }}" method="POST" class="bg-white rounded-lg p-6">
            @csrf
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input id="tglPenyuluhan" name="tglPenyuluhan" type="date" required
                    ...
                    <select id="fasyankes" name="fasyankes"  required
                        ...
                        @if ($fasyankess)
                            @foreach ($fasyankess as $fasyankes)
                                <option value="{{ $fasyankes->id }}" {{ $fasyankes->id == $fasyanId ? 'selected':'' }}>
