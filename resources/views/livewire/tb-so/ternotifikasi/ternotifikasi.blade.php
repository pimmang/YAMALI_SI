    ...
    @if ($status == 'list')
        <div class="w-full flex flex-col gap-5 h-full">
            ...
            <livewire:component.filter-data>
                <div class="relative flex  shadow-md sm:rounded-lg  uppercase overflow-hidden">
                        ...
                        <table class="w-full text-sm text-left  rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                @foreach ($datas as $data)
                                    <tr class="odd:bg-white  even:bg-orange-50 border-b whitespace-nowrap capitalize">
                    ...
                    <table class="w-1/12 text-sm text-left mb-10  rtl:text-right text-gray-500 dark:text-gray-400">
                        <thead
